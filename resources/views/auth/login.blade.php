...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>PROGRAMA DE EDUCACION | CABILDO DE GUAMBIA- SILVIA CAUCA</title>
...
<body>
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="mp4/misakeducacion.mp4" type="video/mp4">
  </video>
      ...
      <div class="row h-100">
        <div class="col-12 my-auto">
          <div class="masthead-content text-white py-5 py-md-0">
            ...
            <img  style="width:550px" src="{{ asset('images/logo.jpg') }}" alt="">
                </a>
  ...
  <div class="social-icons">
                    ...
                    <div class="copyright">
                        &copy;2020 Todos los Derechos Reservados |Programa de Educacion - Cabildo de Guambia
                    </div>
