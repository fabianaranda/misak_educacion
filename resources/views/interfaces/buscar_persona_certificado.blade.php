...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505">
            Programa de Educacion |Cabildo de Guambia &gt; <font color="#060505">Menu Certificados </font> &gt; <font
                color="#060505">Buscar Persona Para certificado</font> </span>
</div>
            ...
            <div class="col-md-4">
                <div class="profile_bg">
                    ...
                    <div class="account-status-data">
                        ...
                        <form id="" class="form_cunsulta" name="form" action="/Buscar-Persona" method="POST"
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i>Informacion de la persona a generar certificado </a>
                            </li>
