...
<link rel="stylesheet" href="css/estilos_pie_pagina.css">
    ...
    <div class="pull-left breadcrumb_admin clear_both">
      <div class="pull-left page_title theme_color">
        <h1>CERTIFICADO </h1>
        <h2 class=""> Genedar  el Certificado de  Registo</h2>
      </div>
      <div class="pull-right">
        <ol class="breadcrumb">
          <li><a href="#">Inicio</a></li>
          <li><a href="#"> Certificado de Registro en el Sistema</a></li>
          <li class="active">Buscar  certificado del trabajador</li>
        </ol>
      </div>
    </div>
       ...
       <br>
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
           ...
           Programa de Educacion |Cabildo de Guambia  &gt; <font color="#060505">Menu Certificados </font> &gt; <font color="#060505">Buscar Persona Para certificado de registro en el sistema</font> </span>        
         </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="profile_bg">
              ...
              <form id=""  class="form_cunsulta" name="form" action="/Certificados-Registro-Sistema" method="POST" role="informacion-perosona" class="pocicion_formulario">
                             {{ csrf_field() }}
          ...
          <div class="ContenedorFormularioCenso">
            <div class="block-web full">
              <ul class="nav nav-tabs nav-justified nav_bg">  
                <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i class="fa fa-laptop"></i>Iformacion de trabajador  </a></li>
              ...
              <!--
                  <td width="10px">
                              ...
                              <td width="10px">
                              <a href="{{ route('Certificado-registros', $persona->id)}}" 
