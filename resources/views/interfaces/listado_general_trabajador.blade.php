...
<link rel="stylesheet" href="css/estilos_pie_pagina.css">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>LISTADO GENERAL TRABAJADORES </h1>
          <h2 class=""></h2>
        </div>
       ...
       <br>
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
           <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Programa de Educacion- Cabildo de Guambia &gt; <font color="#060505">Menu trabajadores </font> &gt; <font color="#060505">Listado General Trabajadores</font> </span>        
         </div>
             ...
             <div class="ContenedorFormularioCenso">
              <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                 <li class="active"><a data-toggle="tab" href="#Tab1">LISTADO GENERAL </a></li>
