 ...
 <link rel="stylesheet" href="{{ asset('css/estilos_pie_pagina.css')}}">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Personal</h1>
          <h2 class="">Actualizacion de Datos</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><a href="#">Personal</a></li>
            <li class="active">Actualizacion Datos </li>
          </ol>
        </div>
      </div>
      <br>
      ...
      <!--informacion donde se encuentra-->
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
           <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Programa de Educacion -Cabiildo de Guambia &gt; <font color="#060505">Actualizacion Datos   </font> &gt; <font color="#060505"> </font> </span>        
         </div>
...
<!-- INICIO DE  CODIGO DE FORMULARIO -->
                            ...
                            <div class="ContenedorFormularioCenso">
		                     ...
		                     --->
                              ...
                              <!-- FIN TABLE-->
                                       ...
                                       Actualizacion de informacion  del empleado  segun codigo de contrato 
                                        </h2>
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <label ><span class="asterisco">*</span>Nombres</label>
                   <input name="nombre" type="text"  value="{{$datos->nombre}}"  onkeyup="this.value = this.value.toUpperCase();"  class="form-control" style="" autocomplete="of"    required=""  >
              </div>
		        
			      	  <div class="form-group input-group-sm">
                    <label ><span class="asterisco">*</span>Apellidos</label>
                   <input name="apellidos" type="text" value="{{$datos->apellidos}}"  onkeyup="this.value = this.value.toUpperCase();"  class="form-control" style="" autocomplete="of"  value=""  required=""  >
               </div>

          <div class="form-group input-group-sm">
            <label ><span class="asterisco">*</span>Tipo Identificación</label>
            <select name="tipo_identificacion" type="text" value="{{$datos->tipo_identificacion}}" maxlength="20" id="txtPrimerNombre" autocomplete="of" class="form-control " required="" >
              ...
              <option value="PASAPORTE">Pasaporte</option>
                   ...
                   <input name="documento_identidad" value="{{$datos->documento_identidad}}" type="number" min="30000000" min="9999999999" class="form-control" style="" autocomplete="of"  value="" required=""  >
               </div>
         ...
         <div class="form-group input-group-sm">
           ...
           <select name="sexo" type="text"  value="{{$datos->sexo }}" maxlength="20"  autocomplete="of" class="form-control "  required="">
  ...
  <!--
   ...
   <div class="form-group input-group-sm">
                   ...
                   <input name="telefono" type="text" value="{{$datos->telefono}}" class="form-control" style="" autocomplete="of"  value="" required=""  >
               </div>
   ...
   <div class="form-group input-group-sm">
     <label for="title">* Programa </label>
                ...
                <div class="form-group input-group-sm">
                   ...
                   <input name="ocupacion" type="text"  value="{{$datos->ocupacion}}" class="form-control" style="" autocomplete="of"  value=""  required="" >
               </div>
        ...
        <select name="departamento" id="departamento" class="form-control" style="width:" required="" >
             ...
             <label for="title">Seleccione Municipio:</label>
                ...
                <div class="form-group input-group-sm">
                   ...
                   <input name="direccion" type="text"  value="{{$datos->direccion}}" class="form-control" style="" autocomplete="of"  value=""  required="" >
             </div>
             <!--
   ...
   .boton_Cancelar {
    ...
    margin-left: 600px;
            ...
            <td width="10%" class="subtitulo3" >
                              <a href="{{ route('Informacion-trabajador', $datos->id)}}" 
