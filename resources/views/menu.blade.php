...
<head>
  ...
  <title>{{ config('menu2.name', 'PROGRAMA DE EDUCACION -CABILDO DE GUAMBIA | SILVIA CAUCA') }}</title>
...
<!--header top-->
  ...
  <div class="header_bar " >
    ...
    <div class="header_top_bar">
      ...
      <a  class="add_user" > <i class="fa fa-plus-square"></i>  Bienvenido a PECG</a>
	 ...
	 <!--
          ...
          <ul class="dropdown-menu">
            ...
            <li> <a href="#"><i class="fa fa-question-circle"></i>Many Wam</a> </li>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
					   ...
					   <li class="active">
                        ...
                        <li>
                              <a href="{{ url('Menu-certificados') }}">CERTIFICADOS</a>
                        </li>
                        <li>
                        
                              <a href="{{ url('Ingresar-Trabajador') }}">TRABAJADOR </a>
                        </li>
                        <!--
                        <li>
                       ...
                       -->
                         <li>
                              <a href="{{ url('Menu-administrador') }}">Administración</a>
                        </li>
