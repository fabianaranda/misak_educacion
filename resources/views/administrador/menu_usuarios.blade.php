      ...
      <div class="container">
		...
		-->
                             <td style="width:3px;"></td>
			                           ...
			                           <tbody>
			                            <tr>
				                           <td ><b href="" > USUARIOS INGRESADOS EN  PECG </b></td>
			                             </tr>
		                               </tbody>
		                                </table>
		                          </td>
                          ...
                          <td  title="Información de la persona que viven dentro de la familia " >
		                       <table   class="active">
			                       <tbody>
			                        <tr>
				                      <td >
				                          <b  onclick="location.href='{{ url('Ingresar_Usuarios') }}'" > INGRESAR  NUEVO USUARIO AL SISTEMA PECG </b>
				                    </td>
			                        </tr>
		                         </tbody>
                              ...
                              <div  class="color_infor noPrint" style="margin-top: 15px;">  
					                     <span  class="color_infor  noPrint">Usted se encuentra en:&nbsp;&nbsp;Usuarios  &gt; <font color="#666666"> Nuevos Usuarios PECG </font></span>        
			                     </div>
