...
@section('content')
      ...
      <div class="container">
                          ...
                          <td  title="Información de la persona que viven dentro de la familia " >
		                       <table   class="active">
			                       <tbody>
			                        <tr>
				                      <td >
				                          <b   onclick="location.href='{{ url('Menu-Usuarios') }}'"  >USUARIOS INGRESADOS EN  PECG </b>
				                    </td>
			                        </tr>
		                         </tbody>
                             ...
                             <td style="width:3px;"></td>
			                           ...
			                           <tbody>
			                            <tr>
				                           <td ><b href="" > INGRESAR  NUEVO USUARIO AL SISTEMA PECG</b></td>
			                             </tr>
		                               </tbody>
		                                </table>
		                          </td>
		<!--
		                   <td style="width:3px;"></td>
				             ...
				             <td style="width:3px;"></td>
                              ...
                              <div  class="color_infor noPrint" style="margin-top: 15px;">  
					                     <span  class="color_infor  noPrint">Usted se encuentra en:&nbsp;&nbsp;Usuarios  &gt; <font color="#666666"> Nuevos Usuarios en PECG </font></span>        
			                     </div>
	                      ...
	                      <form name="" id="Hogar" method="post" {{ route('Ingresar_Usuarios') }}  action="Ingresar_Usuarios/Guardado" entype="multipart/form-data">
						...
						<div class="form-group row">
                            <label for="apellidos" class="col-md-4 col-form-label text-md-right">{{ __('Nombre') }}</label>

                            <div class="col-md-6">
                                <input id="apellidos" type="text" class="form-control @error('name') is-invalid @enderror" name="apellidos" value="{{ old('apellidos') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="cedula" class="col-md-4 col-form-label text-md-right">{{ __('Nomero de Cedula') }}</label>

                            <div class="col-md-6">
                                <input id="cedula" type="cedula" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('cedula') }}" required autocomplete="cedula">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Contraseña Asignado') }}</label>
                       ...
                       <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="cargo" type="text" class="form-control @error('name') is-invalid @enderror" name="cargo" value="{{ old('cargo') }}" required autocomplete="cargo" autofocus>
                                 ...
                                 <option value="Coordinadora general">Coordinadora general</option>
                                  ...
                                  <option value="Coordinador cultural">Coordinador cultural</option>
                        ...
                        <div class="form-group row">
                            <label for="fin_contrato" class="col-md-4 col-form-label text-md-right">{{ __('Fecha Final del contrato') }}</label>

                            <div class="col-md-6">
                                <input id="fin_contrato" type="date" class="form-control @error('name') is-invalid @enderror" name="fin_contrato" value="{{ old('fin_contrato') }}" required autocomplete="fin_contrato" >
                        ...
                        <div class="form-group row">
                        <label for="avatar" class="col-md-4 col-form-label text-md-right">{{ __('Cargar Foto') }}</label>

                          <div class="col-md-6">
                                  <input id="fin_contrato" type="file" class="form-control @error('name') is-invalid @enderror" name="avatar" >
